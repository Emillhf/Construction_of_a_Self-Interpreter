...
tape_BinInc=$(find "1_Tape_tapes" -maxdepth 1 -type f -name "BinInc.txt")
tape_BinDec=$(find "1_Tape_tapes" -maxdepth 1 -type f -name "BinDec.txt")
...
case1_rev_out=$(dotnet run --project Interpreter_1_tape "$left_t1_right_t3" "$case1_rev" 1 161 4)
...
case2_rev_out=$(dotnet run --project Interpreter_1_tape "$left_t1_right_t3" "$case2_rev" 1 161 4)
...
case3_rev_out=$(dotnet run --project Interpreter_1_tape "$left_t1_right_t3" "$case3_rev" 1 161 3)
...
case4_out=$(dotnet run --project Interpreter_1_tape "$right_t1_left_t3" "$case4" 1 161 2)
...
case4_rev_out=$(dotnet run --project Interpreter_1_tape "$left_t1_right_t3" "$case4_rev" 1 161 3)
...
case5_out=$(dotnet run --project Interpreter_1_tape "$right_t1_left_t3" "$case5" 1 161 4)
...
case5_rev_out=$(dotnet run --project Interpreter_1_tape "$left_t1_right_t3" "$case5_rev" 1 161 5)
