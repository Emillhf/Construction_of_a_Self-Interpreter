...
let rev_URTM: Map<int,Rule list> = read_rules("1_Tape_programs/rev_URTM.txt")
...
let input_URTM = [|'b';'b';'$';'p';'1';'0';'$';'p';'M';'#';'1';'#';'0';'1';'#';'0';'1';'#';'M';'S';'#';'1';'0';'#';'1';'B';'#';'0';'#';'S';'b';'$';'p';'$';'b';'b';'b';'b'|]
let input_rev_URTM = [|'b';'b';'$';'p';'$';'p';'M';'#';'1';'#';'1';'0';'#';'0';'1';'#';'M';'S';'#';'1';'0';'#';'0';'B';'#';'0';'#';'S';'b';'$';'p';'$';'b';'b';'b';'b'|]


let input_test_infinate_one_long = [|'b';'b';'$';'I';'$';'p';'$';'I';'$';'b';'b'|] //STARTING IDX CHANGED TO 4
let input_test_infinate_one_long1 = [|'b';'b';'$';'I';'$';'p';'$';'I';'$';'b';'b'|] //STARTING IDX CHANGED TO 4
let input_test_infinate_two_long = [|'b';'$';'p';'1';'$';'p';'$';'1';'p';'$';'b';'b'|] //STARTING IDX CHANGED TO 4
let input_test_infinate_two_long1 = [|'b';'$';'1';'p';'$';'p';'$';'p';'1';'$';'b';'b'|] //STARTING IDX CHANGED TO 4
let input_test_infinate_case1 = [|'b';'$';'1';'1';'O';'$';'p';'$';'I';'1';'0';'0';'$';'b'|] //STARTING IDX CHANGED TO 4
let rev_input_test_infinate_case1 = [|'$';'1';'1';'0';'p';'$';'b';'p';'b';'$';'p';'1';'1';'0';'0';'$'|]
...
let rev_test_infinate_case_right = read_rules("1_Tape_programs/rev_move_right_t1_left_t3.txt")
let rev_test_infinate_case_left = read_rules("1_Tape_programs/rev_move_left_t1_right_t3.txt")

// printfn "%A" (RMT (test_infinate_case_right, (1,161), input_test_infinate_one_long, Some 3)) 
// printfn "%A" (RMT (test_infinate_case_left, (1,161), input_test_infinate_one_long1, Some 3)) 

// printfn "%A" (RMT (test_infinate_case_right, (1,161), input_test_infinate_two_long, Some 2)) 
// printfn "%A" (RMT (test_infinate_case_left, (1,161), input_test_infinate_two_long1, Some 3)) 

// printfn "%A" (RMT (rev_test_infinate_case_left, (161,1), input_test_infinate_one_long, Some 3)) 
// printfn "%A" (RMT (rev_test_infinate_case_left, (161,1), input_test_infinate_one_long1, Some 3)) 

// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), input_test_infinate_two_long, Some 2)) 
// printfn "%A" (RMT (rev_test_infinate_case_left, (161,1), input_test_infinate_two_long1, Some 3)) 


// printfn "%A" (RMT (test_infinate_case_right, (1,161), input_test_infinate_case1, Some 4)) 
// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case1, Some 4)) 
// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case1, Some 4) = input_test_infinate_case1) 
// printfn "%A\n" (RMT (test_infinate_case_left, (1,161), rev_input_test_infinate_case1, Some 4))  
// printfn "%A\n" (RMT (rev_test_infinate_case_left, (161,1), input_test_infinate_case1, Some 4))  


// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case2, Some 4)) 
// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case2, Some 4) = input_test_infinate_case2) 
// printfn "%A\n" (RMT (rev_test_infinate_case_left, (161,1), input_test_infinate_case2, Some 3)) 

// printfn "%A" (RMT (test_infinate_case_right, (1,161), input_test_infinate_case3, Some 3))
// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case3, Some 3))
// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case3, Some 3)  = input_test_infinate_case3) 
// printfn "%A\n" (RMT (test_infinate_case_left, (1,161), rev_input_test_infinate_case3, Some 3)) 
// printfn "%A\n" (RMT (rev_test_infinate_case_left, (161,1), input_test_infinate_case3, Some 2)) 

// printfn "%A" (RMT (test_infinate_case_right, (1,161), input_test_infinate_case4, Some 3)) 
// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case4, Some 3)) 
// printfn "%A" (RMT (rev_test_infinate_case_right, (161,1), rev_input_test_infinate_case4, Some 3) = input_test_infinate_case4) 
// printfn "%A\n" (RMT (test_infinate_case_left, (1,161), rev_input_test_infinate_case4, Some 3)) 
// printfn "%A\n" (RMT (rev_test_infinate_case_left, (161,1), input_test_infinate_case4, Some 2)) 

// printfn "%A" (RMT (test_infinate_case_right, (1,161), input_test_infinate_case5, Some 5))
...
printfn "%A" (RMT (rev_URTM,(29518,1),input_rev_URTM, Some 3))
